...
public class GuiCustomMainMenu extends Screen {
    ...
    private static final ResourceLocation CUSTOM_BUTTON_TEXTURE = new ResourceLocation("fantasia:textures/gui/mainbutton.png");
    private static final ResourceLocation DISCORD_BUTTON = new ResourceLocation("fantasia:textures/gui/discordbutton.png");
    ...
    public GuiCustomMainMenu(boolean p_i51107_1_) {
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, j + 72 + 12, 98, 20, new TranslationTextComponent("test"), (p_213094_1_) -> {
            this.minecraft.setScreen(new OptionsScreen(this, this.minecraft.options));
        }));
        ...
        this.addButton(new ImageButton(this.width / 2 - 124, j + 72 - 22, 20, 20, 0, 0, 18, DISCORD_BUTTON, 40, 40, (p_213090_1_) -> {
            Util.getPlatform().openUri("https://discord.gg/vjBUABdYKf");

        }, new TranslationTextComponent("DiscordButton")));
    ...
    private void createNormalMenuOptions(int p_73969_1_, int p_73969_2_) {
        ...
        /*this.addButton(new Button(this.width / 2 - 100, p_73969_1_, 200, 20, new TranslationTextComponent("Play"), (p_213089_1_) -> {
            this.join(new ServerData("51.210.219.86", "40820", true));
        }));*/
